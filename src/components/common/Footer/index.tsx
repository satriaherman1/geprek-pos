import { Box, Button, Container, Flex, Heading, List, ListItem, Text, useColorModeValue, useMediaQuery, Icon } from "@chakra-ui/react";
...
export default function Footer() {
  ...
  return (
    <Box as="footer" paddingTop="50px" bg={footerBg} color="white">
      ...
      <Box paddingY="20px" textAlign="center" bg="#283140" marginTop={mediumScreen ? "120px" : "40px"}>
